...
def upgrade() -> None:
    ...
    if not op.get_bind().dialect.has_table(op.get_bind(), 'proposal_intake'):
        ...
        op.create_index(op.f('ix_proposal_intake_author_id'), 'proposal_intake', ['author_id'], unique=False)
        op.create_index(op.f('ix_proposal_intake_guild_id'), 'proposal_intake', ['guild_id'], unique=False)
        op.create_index(op.f('ix_proposal_intake_status'), 'proposal_intake', ['status'], unique=False)
    ...
    with op.batch_alter_table('announcement_channel_monitor', schema=None) as batch_op:
        ...
        batch_op.create_index(op.f('ix_announcement_channel_monitor_announcement_id'), ['announcement_id'], unique=False)
        batch_op.create_index(op.f('ix_announcement_channel_monitor_channel_id'), ['channel_id'], unique=False)
    ...
    with op.batch_alter_table('confirmation_session', schema=None) as batch_op:
        ...
        batch_op.create_index(op.f('ix_confirmation_session_context'), ['context'], unique=False)
        batch_op.create_index(op.f('ix_confirmation_session_status'), ['status'], unique=False)
        batch_op.create_index(op.f('ix_confirmation_session_target_id'), ['target_id'], unique=False)
    ...
    with op.batch_alter_table('user_activity', schema=None) as batch_op:
        ...
        batch_op.create_index(op.f('ix_user_activity_context_thread_id'), ['context_thread_id'], unique=False)
        batch_op.create_index(op.f('ix_user_activity_user_id'), ['user_id'], unique=False)
        batch_op.create_unique_constraint('uk_user_activity_per_thread', ['user_id', 'context_thread_id'])

    with op.batch_alter_table('user_vote', schema=None) as batch_op:
        batch_op.add_column(sa.Column('option_type', sa.Integer(), nullable=False, server_default='0'))
        batch_op.drop_index('ix_uservote_sessionId')
        batch_op.drop_index('ix_uservote_userId')
        batch_op.create_index(op.f('ix_user_vote_session_id'), ['session_id'], unique=False)
        batch_op.create_index(op.f('ix_user_vote_user_id'), ['user_id'], unique=False)
        batch_op.create_unique_constraint('uk_user_vote_type_option', ['session_id', 'user_id', 'option_type', 'choice_index'])
    ...
    with op.batch_alter_table('vote_option', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('data_status', sa.Integer(), nullable=False, server_default='1'))
        ...
        batch_op.create_unique_constraint('uk_vote_option_session_type_choice', ['session_id', 'option_type', 'choice_index'])

    with op.batch_alter_table('vote_session', schema=None) as batch_op:
        batch_op.add_column(sa.Column('session_type', sa.Integer(), nullable=False, server_default='1'))
        ...
        batch_op.create_index(op.f('ix_vote_session_session_type'), ['session_type'], unique=False)
        batch_op.create_index(op.f('ix_vote_session_status'), ['status'], unique=False)
        batch_op.create_index(op.f('ix_vote_session_voting_channel_message_id'), ['voting_channel_message_id'], unique=False)
