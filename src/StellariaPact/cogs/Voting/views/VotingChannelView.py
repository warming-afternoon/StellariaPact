...
class VotingChannelView(discord.ui.View):
    ...
    # --- 第一行 ---
    @discord.ui.button(label="🗳️ 投票管理", style=discord.ButtonStyle.primary, row=0, custom_id="mirror_btn_manage_vote")
    ...
    @discord.ui.button(label="⚙️ 规则管理", style=discord.ButtonStyle.secondary, row=0, custom_id="mirror_btn_manage_rules")
