...
class VoteView(discord.ui.View):
    ...
    # --- 第一行 ---
    @discord.ui.button(label="🗳️ 投票管理", style=discord.ButtonStyle.primary, row=0, custom_id="btn_manage_vote")
    ...
    @discord.ui.button(label="⚙️ 规则管理", style=discord.ButtonStyle.secondary, row=0, custom_id="btn_manage_rules")
    ...
    # --- 第二行 ---
    @discord.ui.button(label="➕ 创建普通投票", style=discord.ButtonStyle.success, row=1, custom_id="btn_create_normal")
    ...
    @discord.ui.button(label="🚨 创建异议", style=discord.ButtonStyle.danger, row=1, custom_id="btn_create_objection")
